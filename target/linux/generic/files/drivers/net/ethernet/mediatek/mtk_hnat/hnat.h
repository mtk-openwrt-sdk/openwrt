...
#define GDM1_ALL_FRC_MASK                                                      \
	(GDM1_UFRC_MASK | GDM1_BFRC_MASK | GDM1_MFRC_MASK | GDM1_OFRC_MASK)
...
#define GDM2_ALL_FRC_MASK                                                      \
	(GDM2_UFRC_MASK | GDM2_BFRC_MASK | GDM2_MFRC_MASK | GDM2_OFRC_MASK)
/*QDMA_PAGE mask*/
...
/* If user wants to change default FOE entry number, both DEF_ETRY_NUM and DEF_ETRY_NUM_CFG need to be modified. */
#define DEF_ETRY_NUM 16384	/* feasible values : 16384, 8192, 4096, 2048, 1024 */
#define DEF_ETRY_NUM_CFG TABLE_16K	/* corresponding values : TABLE_16K, TABLE_8K, TABLE_4K, TABLE_2K, TABLE_1K */
...
#define BITS_GDM1_ALL_FRC_P_PPE                                                \
	(BITS_GDM1_UFRC_P_PPE | BITS_GDM1_BFRC_P_PPE | BITS_GDM1_MFRC_P_PPE |  \
	 BITS_GDM1_OFRC_P_PPE)
...
#define BITS_GDM1_ALL_FRC_P_CPU_PDMA                                           \
	(BITS_GDM1_UFRC_P_CPU_PDMA | BITS_GDM1_BFRC_P_CPU_PDMA |               \
	 BITS_GDM1_MFRC_P_CPU_PDMA | BITS_GDM1_OFRC_P_CPU_PDMA)
...
#define BITS_GDM1_ALL_FRC_P_CPU_QDMA                                           \
	(BITS_GDM1_UFRC_P_CPU_QDMA | BITS_GDM1_BFRC_P_CPU_QDMA |               \
	 BITS_GDM1_MFRC_P_CPU_QDMA | BITS_GDM1_OFRC_P_CPU_QDMA)
...
#define BITS_GDM1_ALL_FRC_P_DISCARD                                            \
	(BITS_GDM1_UFRC_P_DISCARD | BITS_GDM1_BFRC_P_DISCARD |                 \
	 BITS_GDM1_MFRC_P_DISCARD | BITS_GDM1_OFRC_P_DISCARD)
...
#define BITS_GDM2_ALL_FRC_P_PPE                                                \
	(BITS_GDM2_UFRC_P_PPE | BITS_GDM2_BFRC_P_PPE | BITS_GDM2_MFRC_P_PPE |  \
	 BITS_GDM2_OFRC_P_PPE)
...
#define BITS_GDM2_ALL_FRC_P_CPU_PDMA                                           \
	(BITS_GDM2_UFRC_P_CPU_PDMA | BITS_GDM2_BFRC_P_CPU_PDMA |               \
	 BITS_GDM2_MFRC_P_CPU_PDMA | BITS_GDM2_OFRC_P_CPU_PDMA)
...
#define BITS_GDM2_ALL_FRC_P_CPU_QDMA                                           \
	(BITS_GDM2_UFRC_P_CPU_QDMA | BITS_GDM2_BFRC_P_CPU_QDMA |               \
	 BITS_GDM2_MFRC_P_CPU_QDMA | BITS_GDM2_OFRC_P_CPU_QDMA)
...
#define BITS_GDM2_ALL_FRC_P_DISCARD                                            \
	(BITS_GDM2_UFRC_P_DISCARD | BITS_GDM2_BFRC_P_DISCARD |                 \
	 BITS_GDM2_MFRC_P_DISCARD | BITS_GDM2_OFRC_P_DISCARD)
...
#define skb_hnat_is_hashed(skb)                                                \
	(skb_hnat_entry(skb) != 0x3fff && skb_hnat_entry(skb) < foe_etry_num)
...
#define FROM_EXT(skb) (HNAT_SKB_CB(skb)->iif == FOE_MAGIC_EXT)
#define FOE_MAGIC_GE_WAN 0x7273
#define FOE_MAGIC_GE_LAN 0x7272
#define FOE_MAGIC_GE_PPD 0x7279
#define FOE_MAGIC_GE_VIRTUAL 0x727a
#define FOE_MAGIC_EXT 0x727e
...
#define IS_WHNAT(dev) ((get_wifi_hook_if_index_from_dev(dev) != 0) ? 1 : 0)
#define IS_EXT(dev) ((get_index_from_dev(dev) != 0) ? 1 : 0)
#define IS_PPD(dev) (!strcmp(dev->name, host->ppd))
...
#define ei(entry, end) (foe_etry_num - (int)(end - entry))
...
extern struct timer_list hnat_sma_build_entry_timer;
...
extern struct net_device *g_ppdev;
extern struct net_device *wifi_hook_if[MAX_IF_NUM];
extern struct extdev_entry *ext_if[MAX_EXT_DEVS];
extern int dbg_cpu_reason;
extern int debug_level;
extern int hook_toggle;
extern u32 foe_etry_num;
