...
define Device/MT7629-LYNX-EVB1
  DEVICE_TITLE := MTK7629 LYNX EVB1
  DEVICE_DTS := mt7629-lynx-evb1
  DEVICE_PACKAGES := regs luci ppp-mod-pptp xl2tpd wireless-tools \
                luci-app-mtk luci-app-samba block-mount kmod-fs-vfat kmod-fs-ext4
endef

TARGET_DEVICES += MT7629-LYNX-EVB1

define Device/MT7629-LYNX-EVB2
  DEVICE_TITLE := MTK7629 LYNX EVB2
  DEVICE_DTS := mt7629-lynx-evb2
  DEVICE_PACKAGES := regs luci ppp-mod-pptp xl2tpd wireless-tools \
                luci-app-mtk luci-app-samba block-mount kmod-fs-vfat kmod-fs-ext4
endef

TARGET_DEVICES += MT7629-LYNX-EVB2

define Device/MT7629-LYNX-RFB3
  DEVICE_TITLE := MTK7629 LYNX RFB3
  DEVICE_DTS := mt7629-lynx-rfb3
  DEVICE_PACKAGES := regs luci ppp-mod-pptp xl2tpd wireless-tools \
                luci-app-mtk luci-app-samba block-mount kmod-fs-vfat kmod-fs-ext4
endef

TARGET_DEVICES += MT7629-LYNX-RFB3
